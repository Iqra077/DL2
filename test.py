...
from tensorflow.keras.layers import Embedding, Input, Dense, Flatten, Dropout, LSTM, Concatenate
...
# Ensure 'Difficulty_Level' exists in resources_data
if 'Difficulty_Level' not in resources_data.columns:
    resources_data['Difficulty_Level'] = 'Medium'  # Default placeholder
...
# Label encoding for student IDs and topics
...
# Prepare data for the NCF model
...
print(resources[['Resource_ID', 'Topic', 'Platform', 'Type', 'Resource_Link', 'Difficulty_Level']])
